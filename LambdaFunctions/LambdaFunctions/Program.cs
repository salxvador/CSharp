...
namespace LambdaFunctions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Lambda fn to add all employees with Id > 5
            List<Employee> gt5 = empsList.Where(e => e.Id > 5).ToList();
            Console.WriteLine("Lambda fn added all emps with id > 5 to list 'gt5':");
            //print out employees in list generated by lambda
            foreach (Employee emp in gt5)
            {
